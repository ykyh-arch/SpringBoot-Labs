...
public class AppController {
    ...
    public ReturnT<String> login(String username, String password) {
        ...
        // valid login，这里后续整合认证框架 spring security / shiro 处理
        ...
        // 3、login, store storeKey，存入分布式缓存 redis
        SsoTokenLoginHelper.login(sessionId, xxlUser);

        // 4、return sessionId，如：1000_d01d2dff3c00416c9837525c2494f5b0
    ...
    public ReturnT<String> logout(String sessionId) {
        // logout, remove storeKey，从分布式缓存 redis 移除相关用户信息
