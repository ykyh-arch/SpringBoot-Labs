package cn.iocoder.springboot.lab77.ratelimiter.aop;
...
public class LimitInterceptor {
    ...
    @Around("execution(public * cn.iocoder.springboot.lab77.ratelimiter.controller.*.*(..)) && @annotation(cn.iocoder.springboot.lab77.ratelimiter.annoation.Limit)")
