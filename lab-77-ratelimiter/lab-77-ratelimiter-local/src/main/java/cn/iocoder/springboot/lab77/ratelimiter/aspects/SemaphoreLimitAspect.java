...
/**
 * SemaphoreLimitAspect
 *
 * @author jaquez
 * @date 2022/07/08 14:04
 **/
@Component
@Scope
@Aspect
public class SemaphoreLimitAspect {
    ...
    /**
     * 存储限流量和方法,必须是 static 且线程安全,保证所有线程进入都唯一
     */
     ...
     * 业务层切点
     */
    @Pointcut("@annotation(cn.iocoder.springboot.lab77.ratelimiter.anno.SemaphoreLimit)")
