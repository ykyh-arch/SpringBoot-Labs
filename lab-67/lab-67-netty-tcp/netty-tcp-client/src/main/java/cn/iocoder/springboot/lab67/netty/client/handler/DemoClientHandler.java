package cn.iocoder.springboot.lab67.netty.client.handler;

import io.netty.channel.ChannelHandlerContext;
import io.netty.handler.timeout.IdleState;
import io.netty.handler.timeout.IdleStateEvent;
import lombok.extern.slf4j.Slf4j;
import cn.iocoder.springboot.lab67.netty.client.NettyClient;
...
/**
 * DemoClientHandler 默认示例客户端处理器，具体由业务去实现！
 *
 */
@Slf4j
@Component
...
public class DemoClientHandler extends BaseClientHandler {
    ...
    public void channelActive(ChannelHandlerContext ctx) throws Exception {
        log.info("客户端，imei={}，通道激活成功", this.imei);
    ...
    public void channelInactive(ChannelHandlerContext ctx) throws Exception {
        log.warn("客户端，imei={}，通道断开连接", this.imei);
    }

    @Override
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        log.info("客户端，imei={}，收到消息:  {}", this.imei, msg);
        // 处理业务...
    ...
    public void userEventTriggered(ChannelHandlerContext ctx, Object evt) throws Exception {
        if (evt instanceof IdleStateEvent) {
            ...
            if (e.state() == IdleState.ALL_IDLE) {
                this.allIdleCounter++;
                log.info("客户端，imei={}触发闲读或写第{}次", this.imei, this.allIdleCounter);
