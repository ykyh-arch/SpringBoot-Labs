...
public class CallbackController {
    ...
    public OAuth2AccessToken login(@RequestParam("code") String code) {
        // 创建 AuthorizationCodeResourceDetails 授权码对象
        ...
        restTemplate.getOAuth2ClientContext().getAccessTokenRequest().setPreservedState("http://127.0.0.1:8080/callback"); // 通过这个方式，设置 redirect_uri 参数
