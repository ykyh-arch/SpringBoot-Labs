package cn.iocoder.springboot.lab01.springsecurity.common;
...
import cn.iocoder.springboot.lab01.springsecurity.utils.SpringUtils;
...
public class DataScopeAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(cn.iocoder.springboot.lab01.springsecurity.common.DataScope)")
    ...
    public static void dataScopeFilter(JoinPoint joinPoint, SysUser user, String deptAlias, String userAlias)
    {
        ...
        {
            BaseDataObject baseEntity = (BaseDataObject) joinPoint.getArgs()[0];
